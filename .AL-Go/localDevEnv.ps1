...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/ashirokikh/AL-Go/fix-error-message/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/ashirokikh/AL-Go/fix-error-message/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/ashirokikh/AL-Go/fix-error-message/Actions/Packages.json' -folder $tmpFolder | Out-Null
